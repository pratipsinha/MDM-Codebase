...
public class AutoVerification implements WorkflowStepFunction 
{
	...
	public void in(WorkflowStepFunctionArguments arg0) 
	{
		...
		try 
		{
			...
			if(null != pimCtx)
			{
				...
				wattsLogger.logInfo("----Logger Object Retrieved successfully :AUTO_VERIFICATION :Workflow_IN-----");
				...
				wattsLogger.logInfo("-:AUTO_VERIFICATION :----------------Print the Step Objects-------------------");
				//wattsLogger.logInfo("-:AUTO_VERIFICATION :-::Collaboration Step Name :: "+collabStepName);
				wattsLogger.logInfo("-:AUTO_VERIFICATION :-::Collaboration Area Name :: "+collabAreaName);
				wattsLogger.logInfo("-:AUTO_VERIFICATION :-::Worklow Step Name       :: "+workflowStepName);
				wattsLogger.logInfo("-:AUTO_VERIFICATION :---------------------------------------------------------");
				...
				{
					wattsLogger.logInfo("-:AUTO_VERIFICATION :--------------ITEM PRIMARY_KEY------------::"+collaborationItem.getPrimaryKey());
			...
			{
				System.out.println("-:AUTO_VERIFICATION :--------The Context is not retrieved properly-------------");
			}
		} catch (Exception e) {
			...
			if(null != wattsLogger)
			{
				wattsLogger.logInfo("-:AUTO_VERIFICATION :----Exception---"+e.getMessage());
			}
