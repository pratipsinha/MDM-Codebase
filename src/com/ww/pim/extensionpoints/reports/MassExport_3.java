...
public class MassExport_3 implements ReportGenerateFunction
{
	...
	{
		objLogger.logDebug("Report MassExport_3 started...");
		String PROPERTY_FILE_NAME = System.getProperty(Constant.DOLLAR_TOP)+"/properties/MassExport.properties";
		Properties properties = null;
		XSSFWorkbook wb = new XSSFWorkbook();
		String outputFileName = System.getProperty(Constant.DOLLAR_TOP)+"/Output Files/Mass_Export/Core_Attribute_Export/Mass_Export_3_";
		...
		try
		{
			...
			query = "select item from catalog('Product Catalog') where item['Product Catalog Global Spec/PIM_ID']  >="+60040+" AND item['Product Catalog Global Spec/PIM_ID']  <"+90000;
