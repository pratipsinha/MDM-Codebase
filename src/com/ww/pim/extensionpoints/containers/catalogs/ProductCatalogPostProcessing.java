...
public class ProductCatalogPostProcessing implements PrePostProcessingFunction{
	UtilityMethods utilityMethods = null;
	@Override
	public void prePostProcessing(ItemPrePostProcessingFunctionArguments arg0) {
		System.out.println("CATALOG New1: Product Catalog Post processing called ......: [OK]");
		...
		logger.logInfo("CATALOG New1: Product Catalog Post processing called : [OK]");
		...
		if (null != catalogItem){
			...
			if (null == catalogItem.getAttributeValue("Product Catalog Global Spec/AlternateItemIdentificationId")){
			...
			*/
			...
			/*if(null != catalogItem.getAttributeValue("Product Catalog Global Spec/BrandName") &&  null != catalogItem.getAttributeValue("Product Catalog Global Spec/DescriptionShort_en-US") )
			{
			 ...
			 logger.logDebug("start // Rule 139..");
				...
				if (catalogItem.getAttributeInstance(Constant.PART_PATH_IN_SPEC).getChildren().size()>0 && catalogItem.getAttributeInstance(Constant.PACK_LEVEL_PATH_IN_SPEC).getChildren().size()> 0){
					...
					while(packLvlIter.hasNext()){
						...
						if (null != catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.UOM_PATH) && "INNER".equalsIgnoreCase(catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.UOM_PATH).toString())){
							...
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath+"/IsTradeItemAConsumerUnit")){
						    	catalogItem.setAttributeValue(higherPackLvlPath+"/IsTradeItemAConsumerUnit","false");
						    }
							 // Rule 68.2 End 
							
							 // Rule 67.2 Start 
							logger.logDebug("start // Rule 67.2..");
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath+"/IsTradeItemAnOrderableUnit")){
						    	catalogItem.setAttributeValue(higherPackLvlPath+"/IsTradeItemAnOrderableUnit","false");
						    }
							 // Rule 67.2 End 
							
							 // Rule 65.2 Start 
							logger.logDebug("start // Rule 65.2..");
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath+"/IsTradeItemABaseUnit")){
						    	catalogItem.setAttributeValue(higherPackLvlPath+"/IsTradeItemABaseUnit","false");
						    }
							 // Rule 65.2 End 
							
							 // Rule 64.2 Start 
							logger.logDebug("start // Rule 64.2..");
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath+"/IsTradeItemAnInvoiceUnit")){
						    	catalogItem.setAttributeValue(higherPackLvlPath+"/IsTradeItemAnInvoiceUnit","false");
						    }
							 // Rule 64.2 End 
							 // Rule 83.2 Start 
							logger.logDebug("start // Rule 83.2..");
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath+"/IsTradeItemADespatchUnit")){
								catalogItem.setAttributeValue(higherPackLvlPath+"/IsTradeItemADespatchUnit", "true");
							...
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath+"/EANUCCType")){
								catalogItem.setAttributeValue(higherPackLvlPath+"/EANUCCType","GTIN_14");
						    }
							 // Rule 66.2 End
							 // Rule 4.7 Start 
							...
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath+"/ProductTypeCode")){
								catalogItem.setAttributeValue(higherPackLvlPath+"/ProductTypeCode","PK");
							}
							 // Rule 69.2 End
							
							 // Rule 73.2 Start 
							logger.logDebug("start // Rule 73.2..");
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath+"/UnitOfMeasureImperial-Dimension")){
								catalogItem.setAttributeValue(higherPackLvlPath+"/UnitOfMeasureImperial-Dimension","Inch");
							}
							 // Rule 73.2 End
							// Rule 76.2 Start 
							logger.logDebug("start // Rule 76.2..");
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath + "/UnitOfMeasureImperial-Volume")){
								catalogItem.setAttributeValue(higherPackLvlPath + "/UnitOfMeasureImperial-Volume","Cubic inch");
						    }
							 // Rule 76.2 End 
							
							 // Rule 74.2 Start 
							logger.logDebug("start // Rule 74.2..");
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath + "/UnitOfMeasureImperial-Weight")){
								catalogItem.setAttributeValue(higherPackLvlPath + "/UnitOfMeasureImperial-Weight","Pound");
						    }
							 // Rule 74.2 End 
							if(null == catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.BAR_CODE_TYPE)){
								logger.logInfo("Item : "+itmPrimaryKey+" Inner Bar Code Type is empty. Setting  Bar Code Type ");
								catalogItem.setAttributeValue(higherPackLvlPath+"/"+Constant.BAR_CODE_TYPE, "ITF_14");
							} 
							// Rule 75.2 Start 
							logger.logDebug("start // Rule 75.2..");
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath + "/PackagingMaterialCompositionQuantityUnit")){
								catalogItem.setAttributeValue(higherPackLvlPath + "/PackagingMaterialCompositionQuantityUnit","Each");
						    }
							 // Rule 75.2 End
						}
						...
						if (null != catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.UOM_PATH) && "MASTER".equalsIgnoreCase(catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.UOM_PATH).toString())){
							...
							logger.logDebug("start // Rule 69.2..");
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath+"/ProductTypeCode")){
								catalogItem.setAttributeValue(higherPackLvlPath+"/ProductTypeCode","CA");
							}
							 // Rule 69.2 End
							// Rule 73.2 Start 
							logger.logDebug("start // Rule 73.2..");
						...
						if (null != catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.UOM_PATH) && "PALLET".equalsIgnoreCase(catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.UOM_PATH).toString())){
							...
							logger.logDebug("start // Rule 69.2..");
							if (null != catalogItem && null == catalogItem.getAttributeValue(higherPackLvlPath+"/ProductTypeCode")){
								catalogItem.setAttributeValue(higherPackLvlPath+"/ProductTypeCode","PL");
							}
							 // Rule 69.2 End
							// Rule 73.2 Start 
							logger.logDebug("start // Rule 73.2..");
				...
				if (null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/ProductTypeCode")){
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/ProductTypeCode","EA");
			    }
				 // Rule 69.1 End 
				 // Rule 14.1 Start 
				...
				else if(null ==  catalogItem.getAttributeValue("Product Catalog Global Spec/Image1FileURL_en-US"))
				{
				 ...
				 // Rule 78.1 End 
				if (null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/BarCodeType")){
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/BarCodeType","UPC_A");
			    }
				 // Rule 66.1 Start 
				logger.logDebug("start // Rule 66.1..");
				if (null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/EANUCCType")){
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/EANUCCType","GTIN_12");
			    }
				 // Rule 66.1 End 
				// Rule 129.1 Start 
				logger.logDebug("start // Rule 129..");
				// Going to populate IsNetContentDeclarationIndicated attribute as false if it is empty
				if(null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsNetContentDeclarationIndicated"))
				{
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsNetContentDeclarationIndicated","false");
				}
				 // Rule 129.1 End 
				 // Rule 130.1 Start 
				logger.logDebug("start // Rule 130..");
				// Going to populate IsPackagingMarkedWithIngredients attribute as false if it is empty
				if(null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsPackagingMarkedWithIngredients"))
				{
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsPackagingMarkedWithIngredients","false");
				}
				 // Rule 130.1 End 
				
				// Rule 65.1 Start 
				logger.logDebug("start // Rule 65.1..");
				if (null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemABaseUnit")){
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemABaseUnit","true");
			    }
				 // Rule 65.1 End 
				
				// Rule 68.1 Start 
				logger.logDebug("start // Rule 68.1..");
				if (null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemAConsumerUnit")){
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemAConsumerUnit","true");
			    }
				 // Rule 68.1 End 
				// Rule 83.4 Start 
				logger.logDebug("start // Rule 83.4..");
				//if (null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemADespatchUnit")){
				if (null != catalogItem ){
					if (catalogItem.getAttributeInstance(Constant.PART_PATH_IN_SPEC).getChildren().size()>0 && catalogItem.getAttributeInstance(Constant.PACK_LEVEL_PATH_IN_SPEC).getChildren().size()> 0){
						logger.logInfo("Item : "+itmPrimaryKey + " Higher Packaging Exists");
						Iterator<? extends AttributeInstance> packLvlIter = catalogItem.getAttributeInstance(Constant.PACK_LEVEL_PATH_IN_SPEC).getChildren().iterator();
						...
						while(packLvlIter.hasNext()){
							...
							logger.logInfo("Item : "+itmPrimaryKey + "Path "+higherPackLvlPath);
							if (null != catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.UOM_PATH) && "INNER".equalsIgnoreCase(catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.UOM_PATH).toString())){
								catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemADespatchUnit", false);
							}
							else if (null != catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.UOM_PATH) && "MASTER".equalsIgnoreCase(catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.UOM_PATH).toString())){
								catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemADespatchUnit", false);
								
							}
							else if (null != catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.UOM_PATH) && "PALLET".equalsIgnoreCase(catalogItem.getAttributeValue(higherPackLvlPath+"/"+Constant.UOM_PATH).toString())){
								catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemADespatchUnit", false);
								
							}
						}
					}else
						catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemADespatchUnit", true);
					
				}
					// Rule 83.4 End 
				 // Rule 64.1 Start 
				logger.logDebug("start // Rule 64.1..");
				if (null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemAnInvoiceUnit")){
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemAnInvoiceUnit","true");
			    }
				 // Rule 64.1 End 
				
				// Rule 67.1 Start 
				logger.logDebug("start // Rule 67.1..");
				if (null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemAnOrderableUnit")){
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemAnOrderableUnit","true");
			    }
				 // Rule 67.1 End
				...
				if(null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/PackagingMaterialCompositionQuantity"))
				{
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/PackagingMaterialCompositionQuantity",1);
				}
				 // Rule 103.1 End 
				 // Rule 75.1 Start 
				logger.logDebug("start // Rule 75.1..");
				if (null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/PackagingMaterialCompositionQuantityUnit")){
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/PackagingMaterialCompositionQuantityUnit","Each");
			    }
				 // Rule 75.1 End 
				 // Rule 98.1 Start 
				logger.logDebug("start // Rule 98.1..");
				...
				if (null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/UnitOfMeasureImperial-Dimension")){
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/UnitOfMeasureImperial-Dimension","Inch");
			    }
				 // Rule 73.1 End
				
				// Rule 76.1 Start 
				logger.logDebug("start // Rule 76.1..");
				if (null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/UnitOfMeasureImperial-Volume")){
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/UnitOfMeasureImperial-Volume","Cubic inch");
			    }
				 // Rule 76.1 End 
				 
				 // Rule 74.1 Start 
				logger.logDebug("start // Rule 74.1..");
				if (null != catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/UnitOfMeasureImperial-Weight")){
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/UnitOfMeasureImperial-Weight","Pound");
			    }
				 // Rule 74.1 End 
				// Rule 115.1 Start 
				logger.logDebug("start // Rule 115..");
				// Going to populate IsTradeItemAVariableUnit attribute as 'false' if it is empty
				if(null!= catalogItem && null == catalogItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemAVariableUnit"))
				{
					catalogItem.setAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemAVariableUnit","false");
				}
				 // Rule 115.1 End 
	...
	public void prePostProcessing(
		...
		System.out.println("Collab Product Catalog Post processing called ......: [OK]");
		Context ctx = PIMContextFactory.getCurrentContext();
		Logger logger = ctx.getLogger(Constant.WORKFLOW_LOGGER_NAME);
...
*/					
				...
				if(null == collabItem.getAttributeValue("Product Catalog Global Spec/IsItemAvailableForDirectToConsumerDelivery"))
				{
					...
					// Going to set Warrenty Attributes 
					logger.logDebug("start // Rule 143.1..");
					if(null != collabItem.getAttributeValue("Product Catalog Global Spec/WarrantyName") && collabItem.getAttributeValue("Product Catalog Global Spec/WarrantyName").toString().trim()!= "")
					{
				...
				if(null != collabStep && (collabStep.getName().equalsIgnoreCase("Marcom Product Data Services Maintenance"))){
					...
					*/
					...
					logger.logDebug("start // Rule 115..");
					// Going to populate IsTradeItemAVariableUnit attribute as 'false' if it is empty
					if(null!= collabItem && null == collabItem.getAttributeValue("Product Catalog Global Spec/Packaging Hierarchy/Each Level/IsTradeItemAVariableUnit"))
					{
					...
					if(collabItem != null  && !IsTradeItemADespatchUnit){
			...
			// Setting AlternateItemIdentificationId with ModelNumber
			if (null == collabItem.getAttributeValue("Product Catalog Global Spec/AlternateItemIdentificationId")){
